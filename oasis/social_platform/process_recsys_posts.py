...
def process_batch(model: AutoModel, tokenizer: AutoTokenizer,
                  batch_texts: List[str], available_device: str):
...
def generate_post_vector(model: AutoModel, tokenizer: AutoTokenizer, texts, available_device,
                         batch_size):
    ...
    for i in range(0, len(texts), batch_size):
        ...
        batch_outputs = process_batch(model, tokenizer, batch_texts, available_device)
