...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run or resume a profile-only Twitter simulation.",
    )
    ...
    parser.add_argument(
        "--variant",
        default="oasis_lite_twitter",
        help="Base run name for DB, checkpoint, and logs.",
    )
    ...
    parser.add_argument("--simulation-concurrency", type=int, default=64)
...
async def main():
    ...
    recsys_config = oasis.RecsysConfig.twitter(
